...
- Full Bilibili `[0,2468)` processing passed with 1,234 samples and 13 detections/screenshots. Full YouTube `0C6bxQsDj-s` `[0,2718)` also passed in [Actions run 34150684415](https://github.com/liftaris/bazaar-ghost/actions/runs/34150684415), with 1,359 samples, 13 detections/screenshots and 11 persisted IGD readings. Its artifact identifies processor commit `823082a`, stable backend commit `1c5428c`, and full-source coverage. An independent follow-up is in progress. An earlier old-layout Bilibili 900-second interval also passed.
