...
CREATE TABLE IF NOT EXISTS "public"."streamers" (
    ...
    "last_seen_streaming_bazaar" timestamp with time zone,
    "total_vods" integer DEFAULT 0,
    "processed_vods" integer DEFAULT 0,
...
CREATE OR REPLACE VIEW "public"."visible_detections" AS
 SELECT "d"."id",
    "d"."chunk_id",
    "d"."vod_id",
    "d"."username",
  ...
  WHERE ("v"."availability" = 'available'::"public"."vod_availability");


ALTER VIEW "public"."visible_detections" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."visible_detections" TO "anon";
GRANT ALL ON TABLE "public"."visible_detections" TO "authenticated";
GRANT ALL ON TABLE "public"."visible_detections" TO "service_role";
